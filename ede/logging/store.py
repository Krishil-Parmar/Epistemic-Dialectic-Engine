...
class TransactionLogger:
    def __init__(self, db_path: str = DEFAULT_DB_PATH):
        ...
        # check_same_thread=False because the logger is cached across Streamlit
        # reruns, which may execute on different worker threads. The _lock
        # below serializes writes so the relaxed thread check stays safe.
